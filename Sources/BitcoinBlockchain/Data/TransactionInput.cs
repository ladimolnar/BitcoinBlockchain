...
namespace BitcoinBlockchain.Data
{
    ...
    public class TransactionInput
    {
        ...
        /// <summary>
        /// Gets the input's script.
        /// </summary>
        public ByteArray InputScript { get; internal set; }

        /// <summary>
        /// Gets a double SHA256 hash that identifies the transaction that has the output that will be consumed by this input.
        ...
        /// </summary>
        public ByteArray SourceTransactionHash { get; internal set; }

        /// <summary>
        /// Gets the index of the output that will be consumed by this input.
        ...
        /// </summary>
        public UInt32 SourceTransactionOutputIndex { get; internal set; }
    }
}
